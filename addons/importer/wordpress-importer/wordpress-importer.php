	...
	class WP_Import extends WP_Importer {
		...
		function import_options() {
			...
			<?php if ( !empty( $this->authors ) ) : ?>
				...
				<?php if ( $this->allow_create_users() ) : ?>
						<p><?php printf( __( 'If a new user is created by WordPress, a new password will be randomly generated and the new user&#8217;s role will be set as %s. Manually changing the new user&#8217;s details will be necessary.', 'wordpress-importer' ), esc_html( get_option( 'defaulong_toolkit_role' ) ) ); ?></p>
					<?php endif; ?>
					<ol id="authors">
		...
		function process_terms() {
			...
			foreach ( $this->terms as $term ) {
				 ...
				 * @since Long_Toolkit Importer 1.0.0
				 */
