jQuery(document).ready(function ($) {
    ...
    $('.js-demo-import-data').on('click', function (e) {
        ...
        var data = new FormData(),
            ...
            $form_import = $('#long_toolkit_importer-upload-form');
    ...
    function gridLayoutImport(theme_id, $theme) {
        ...
        var data = new FormData();
        data.append('action', 'long_toolkit_importer');
        data.append('security', long_toolkit_importer.ajax_nonce);
    ...
    function prepareFile(data, $theme) {
        ...
        $.ajax({
            method: 'POST',
            url: long_toolkit_importer.ajax_url,
            data: data,
            contentType: false,
            processData: false,
            beforeSend: function () {
    ...
    function import_demo(data, $theme) {
        ...
        if (typeof (EventSource) !== "undefined") {
            ...
            data.security = long_toolkit_importer.ajax_nonce;
            data.action = 'long_toolkit_import_demo';
            ...
            eImport.onmessage = function (e) {
                ...
                if (e.lastEventId == 'installing') {
                    ...
                    setTimeout(function () {
                        ...
                        $theme.find('.js-button-import').text(long_toolkit_importer.reimport_text);
