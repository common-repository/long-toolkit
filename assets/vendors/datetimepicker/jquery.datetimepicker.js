...
;(function (factory) {
	...
	var initDateFormatter = function(){
		var locale = defaulong_toolkit_options.i18n[globalLocale],
			opts = {
	...
	$.datetimepicker = {
		setLocale: function(locale){
			var newLocale = defaulong_toolkit_options.i18n[locale]?locale:globalLocaleDefault;
	...
	$.fn.datetimepicker = function (opt, opt2) {
		var result = this,
			...
			YKEY = 89,
			ctrlDown	=	false,
			options = ($.isPlainObject(opt) || !opt) ? $.extend(true, {}, defaulong_toolkit_options, opt) : $.extend(true, {}, defaulong_toolkit_options),
	...
	$.fn.datetimepicker.defaults = defaulong_toolkit_options;
