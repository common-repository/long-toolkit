 ...
 */
function long_toolkit_form_datetime( $settings, $value = '' ) {
	 ...
	 * Css Class
	 */
	$css_class = 'long-toolkit-field long-toolkit-datetime';
	...
	return sprintf( '<div class="%s"><input class="long_toolkit_value" type="text" %s/><i class="fa fa-clock-o" aria-hidden="true"></i></div>', $css_class, implode( ' ', $attrs ) );
}
