 ...
 */
function long_toolkit_form_icon_picker( $settings, $value = '' ) {

	$attrs = array();

	$css_class = 'long-toolkit-field long-toolkit-icon_picker';
	...
	if ( !has_filter( 'long_toolkit_source_' . $source_font ) ) {
		$source_font = 'fontawesome';
	}

	$arr = apply_filters( 'long_toolkit_source_' . $source_font, array() );

	ob_start();

	?>
	<div class="<?php echo esc_attr( $css_class ) ?>">
		<select class="long_toolkit_value" <?php echo implode( ' ', $attrs ) ?>>
			<?php
			if ( !empty( $arr ) ) {
				echo '<option value="">' . esc_attr__( 'No icon', 'long-toolkit' ) . '</option>';
 ...
 */
function long_toolkit_source_fontawesome( $icons ) {
...
add_filter( 'long_toolkit_source_fontawesome', 'long_toolkit_source_fontawesome' );
