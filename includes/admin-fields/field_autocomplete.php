 ...
 */
function long_toolkit_form_autocomplete( $settings, $value ) {
	...
	$placeholder = sprintf( __( 'Please enter %d or more characters', 'long-toolkit' ), $min_length );
	...
	$output .= sprintf( '<div class="long-toolkit-field long-toolkit-autocomplete %s" %s>', $css_class, implode( ' ', $dataAttrs ) );
 ...
 * @return void
 */
function long_toolkit_form_autocomplete_ajax_post_type() {
 ...
 * @return void
 */
function long_toolkit_form_autocomplete_ajax_taxonomy() {
...
add_action( 'wp_ajax_long_toolkit_autocomplete_post_type', 'long_toolkit_form_autocomplete_ajax_post_type' );
add_action( 'wp_ajax_long_toolkit_autocomplete_taxonomy', 'long_toolkit_form_autocomplete_ajax_taxonomy' );
