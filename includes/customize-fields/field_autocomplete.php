 ...
 *
 * @class     Long_Toolkit_Customize_Autocomplete_Control
...
if ( class_exists( 'WP_Customize_Control' ) ):
	...
	/**
	 * Long_Toolkit_Customize_Autocomplete_Control Class
	 */
	class Long_Toolkit_Customize_Autocomplete_Control extends WP_Customize_Control {

		/**
		 * @var string Field type
		 */
		public $type = 'long_toolkit_autocomplete';
		...
		public function render_content() {
			...
			echo long_toolkit_form_autocomplete( $args, $this->value() );
		}
