 ...
 * Class Link Control
 *
 * @class     Long_Toolkit_Customize_Typography_Control
...
if ( class_exists( 'WP_Customize_Control' ) ):
	 ...
	 */
	class Long_Toolkit_Customize_Typography_Control extends WP_Customize_Control {

		/**
		 * @var string Field type
		 */
		public $type = 'long_toolkit_typography';
		...
		public function render_content() {
			...
			echo long_toolkit_form_typography( $args, $this->value() );
		}
