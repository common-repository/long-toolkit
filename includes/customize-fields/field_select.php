 ...
 *
 * @class     Long_Toolkit_Customize_Select_Control
...
if ( class_exists( 'WP_Customize_Control' ) ):
	...
	/**
	 * Long_Toolkit_Customize_Select_Control Class
	 */
	class Long_Toolkit_Customize_Select_Control extends WP_Customize_Control {

		public $type = 'long_toolkit_select';
		...
		public function content_template() {
			...
			<label class="long-toolkit-field long-toolkit-select">
				<# if ( data.label ) { #>
