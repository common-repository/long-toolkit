 ...
 *
 * @class     Long_Toolkit_Customize_Image_Select_Control
...
if ( class_exists( 'WP_Customize_Control' ) ):
	...
	/**
	 * Long_Toolkit_Customize_Image_Select_Control Class
	 */
	class Long_Toolkit_Customize_Image_Select_Control extends WP_Customize_Control {

		/**
		 * @var string Field type
		 */
		public $type = 'long_toolkit_image_select';
		...
		public function render_content() {
			...
			echo long_toolkit_form_image_select( $args, $this->value() );
		}
